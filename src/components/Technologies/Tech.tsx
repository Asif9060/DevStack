    ...
    return (
        <div>
            <div className="max-w-7xl mx-auto">
                <h2 className="font-inter font-extrabold md:text-[36px] text-center md:text-start text-[24px] bg-linear-to-r from-[#EC4899] to-[#8B5CF6] text-transparent bg-clip-text"><span className="text-[#0F172A]">Explore the</span> Technologies</h2>
            ...
            <div className="grid md:grid-cols-4 grid-cols-1 max-w-7xl mx-auto gap-6">
